            ...
            <div class="col-lg-8">
                ...
                <div class="mb-4">
                    <a href="{{ route('questions.show', $question) }}"
                        class="btn btn-link text-decoration-none text-muted ps-0">
                ...
                <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                    <div class="card-header bg-primary text-white p-4 p-md-5 position-relative overflow-hidden">
                        ...
                        <h2 class="fw-bold mb-2 position-relative">Edit Question</h2>
                        <p class="mb-0 text-white-50 position-relative">Update your question details below.</p>
                    </div>
