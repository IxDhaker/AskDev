...
@section('content')
            ...
            <div class="col-md-5">
                <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                    <div class="card-header bg-primary text-white text-center py-4 position-relative overflow-hidden">
                        ...
                        <h4 class="mb-0 fw-bold position-relative">Welcome Back!</h4>
                        <p class="small text-white-50 mb-0 position-relative">Sign in to continue to your dashboard</p>
                    </div>
    ...
    <style>
        ...
        /* Dark mode adjustments for cards will be handled by layout CSS, but specific input group tweaks here */
